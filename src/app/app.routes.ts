...
import { NewReservationComponent } from './pages/reservation/registration/new-reservation.component';
...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'reservation/:RSV_CODE', component: CreateReservationComponent },
